...
export default {
  ...
  methods: {
    btnTabOff(e) {
      // функция, которая проверяет, что у нас открыто это модальное окно и в случае нажатия клавиши Tab убирает стандартное поведение
  ...
  mounted() {
    // отслеживаем за нажатием клавиши Tab
    window.addEventListener('keydown', this.btnTabOff)
  },

  beforeUnmount() {
    // удаляем прослушиватель события за нажатием клавиши Tab
