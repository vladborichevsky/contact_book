<template>
  ...
  <transition-group name="contact-list">
    ...
    >
      ...
      <div>
        <my-button @click="showInfoModal(item)" class="info_btn"> info </my-button>

        <my-button @click="showEditModal(item)" class="edit_btn"> edit </my-button>

        <my-button @click="showDeleteModal(item.id, item.name)" class="delete_btn">
          delete
        </my-button>
      </div>
    </li>
...
export default {
  ...
  emits: ['showInfoModal', 'showEditModal', 'showDeleteModal'],
